...
export class RecipeListComponent implements OnInit {
  ...
  @Output() afterRecipeSelectedEvent = new EventEmitter<RecipeModel>();

  onAfterRecipeSelect(selectedRecipe: RecipeModel) {
    this.afterRecipeSelectedEvent.emit(selectedRecipe);
  }
